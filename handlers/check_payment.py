...
@dp.callback_query_handler(text='naebka')
async def naebka_palka(callback: types.CallbackQuery, state: FSMContext):
    await callback.answer(text = 'You have not paid for the goods. Try again')